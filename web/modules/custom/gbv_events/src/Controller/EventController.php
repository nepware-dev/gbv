...
class EventController extends ControllerBase {
  ...
  public static function getData() {
    ...
    foreach ($nodes as $key => $node) {
      ...
      $eventData[$index]['body'] = $node->get('field_event_body')->getValue() ? $node->get('field_event_body')->getValue()[0]["value"] : NULL;
      $eventData[$index]['uri'] = $node->get('field_event_url')->getValue() ? $node->get('field_event_url')->getValue()[0] : NULL;
